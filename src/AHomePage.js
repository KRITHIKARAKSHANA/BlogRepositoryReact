...
export default function AHomePage(props){
  ...
  useEffect(() => {
    fetch("http://localhost:8085/displayAllBlogs/")
            ...
            <div className="card-header row">
                    ...
                    {(() => {
                        if (b.status == 'verified'){
                            return (
                                <li className="list-group-item"><h6 className="badge bg-success text-black">{b.status}</h6></li>
                            )
                        }else if(b.status=='rejected'){
                            return (
                                <li className="list-group-item"><h6 className="badge bg-danger text-black">{b.status}</h6></li>
                            )
                        }else{
                            return (
                                <li className="list-group-item"><h6 className="badge bg-secondary text-black">{b.status}</h6></li>
                            )
                        }
                        })()}
                    </div>
